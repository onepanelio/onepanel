...
type Workflow struct {
	...
	Environment          bool                 `protobuf:"varint,5,opt,name=environment,proto3" json:"environment,omitempty"`
	Parameters           []*WorkflowParameter `protobuf:"bytes,6,rep,name=parameters,proto3" json:"parameters,omitempty"`
...
func (m *Workflow) GetEnvironment() bool {
	if m != nil {
...
var fileDescriptor_892c7f566756b0be = []byte{
	...
	,
}
