...
var (
	...
	pattern_AuthService_LogIn_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"apis", "v1beta1", "auth", "login"}, "", runtime.AssumeColonVerbOpt(true)))
